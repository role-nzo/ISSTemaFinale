...
with Diagram('coldstorageserviceArch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     transporttrolley >> Edge(color='blue', style='solid', xlabel='coapUpdate', fontcolor='blue') >> ledobserver
     ledobserver >> Edge( xlabel='ledstatuschange', **eventedgeattr, fontcolor='red') >> sys
     sys >> Edge(color='red', style='dashed', xlabel='sonardata', fontcolor='red') >> sonarhandler
     sonarhandler >> Edge( xlabel='stopevent', **eventedgeattr, fontcolor='red') >> sys
     sonarhandler >> Edge( xlabel='resumevent', **eventedgeattr, fontcolor='red') >> sys
     ...
     transporttrolley >> Edge(color='blue', style='solid', xlabel='robotstopfailed', fontcolor='blue') >> sonarhandler
     transporttrolley >> Edge(color='blue', style='solid', xlabel='robotstop', fontcolor='blue') >> sonarhandler
     sys >> Edge(color='red', style='dashed', xlabel='resumevent', fontcolor='red') >> transporttrolley
     transporttrolley >> Edge(color='blue', style='solid', xlabel='robotresume', fontcolor='blue') >> sonarhandler
