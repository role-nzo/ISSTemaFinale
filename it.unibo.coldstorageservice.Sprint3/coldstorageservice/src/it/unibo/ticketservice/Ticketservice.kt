		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t020",targetState="elabNewTicket",cond=whenRequest("newticket"))
					transition(edgeName="t021",targetState="elabStoreFood",cond=whenRequest("storefood"))
					transition(edgeName="t022",targetState="elabUpdateVirtualWeight",cond=whenDispatch("updatevirtualweight"))
				}	 
